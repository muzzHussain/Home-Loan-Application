...
export class GetAllLoanByadvisorService {
  ...
  public async GetAllOpenLoans(): Promise<userLoanApplicationDTO[]> {
    ...
    this.res = await this.httpClient.get<userLoanApplicationDTO[]>(`${this.endpoints.GetAllLoanApplicationByAdvisor}`,  { headers: head }).toPromise();
